...
支付宝服务窗，微信公众号，网站地址，应用名称必须是4选1
	...
	/** 
	 * 签约支付宝身份认证产品的用途，最多5个场景，ISV可以自定义
	 **/
	private $bizScene;
	
	/** 
	 * 数据反馈联系人邮箱地址(使用支付宝身份认证评分、行业关注名单时，联动解决数据问题的接口人。)
	 **/
	private $dataFeedbackContractEmail;
	
	/** 
	 * 数据反馈联系人手机号码(使用支付宝身份认证评分、行业关注名单时，联动解决数据问题的接口人。)
	 **/
	private $dataFeedbackContractMobile;
	
	/** 
	 * 数据反馈联系人姓名(使用支付宝身份认证评分、行业关注名单时，联动解决数据问题的接口人。)
	 **/
